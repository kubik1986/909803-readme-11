...
<html lang="ru">
    ...
    <body class="page">
                            ...
                            <li class="header__profile">
                                <a class="header__profile-link" href="profile.php">
                                    <div class="header__avatar-wrapper">
                                        <img class="header__profile-avatar" src="<?=empty($user['avatar']) ? 'img/icon-input-user.svg' : $avatar_path.$user['avatar']; ?>" alt="Аватар профиля">
                                    </div>
        ...
        <footer class="footer<?= check_main_page() ? ' footer--main' : ''; ?>">
        ...
        <?php if ($include_dz_scripts): ?>
        <script src="libs/dropzone.js"></script>
        <script src="js/dropzone-settings.js"></script>
        <?php endif; ?>
        <?php if ($include_main_script): ?>
